.PHONY: architecture bootstrap check critic install-deps install-deps-postgres preflight staging-drill staging-drill-attachments syntax system-perl test tidy
