...
const my $DEFAULT_MINIMUM_FD_LIMIT        => 1024;
...
sub _open_file_descriptor_check {
    my ( $self, $context ) = @_;
...
sub _file_descriptor_limit_check {
    my ( $self, $context ) = @_;
...
sub _feature_is_unsupported_request {
    my ( $context, $feature, $entry ) = @_;
...
sub _named_state_line {
    my ( $prefix, $name, $entry ) = @_;
