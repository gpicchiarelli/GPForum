...
'Account {username} was created. Check your email to verify before signing in.',
            ...
            'admin.revoke_binding_consequence' =>
              'The user loses this role\'s permissions immediately.',
            'form.confirm_understood'        => 'I understand what this does',
            'moderation.suspend_consequence' =>
'The user cannot sign in or post until the suspension ends or is revoked.',
            'privacy.approve_erasure_consequence' =>
              'Schedules this account\'s personal data for erasure.',
            'privacy.run_erasure_consequence' =>
'Erases this account\'s personal data now. This cannot be undone.',
            'admin.audit_clear_filters'      => 'Clear filters',
            'admin.audit_filters'            => 'Audit filters',
            'admin.audit_from'               => 'From (UTC day)',
            'admin.audit_invalid_filter'     => 'Not a valid value for',
            'admin.audit_older'              => 'Older entries',
            'admin.audit_until'              => 'Until (UTC day)',
            ...
            'admin.failure_type'             => 'Failure type',
            'admin.dead_letter_replay_hint'  =>
'Once the cause is fixed, queue the work again as a new message. The failed message and this record stay as they are.',
            'admin.dead_letter_replayed' =>
...
'Drop every cached public page. Each is rendered again on its next visit; nothing is lost.',
            ...
            'admin.search_index'          => 'Search index',
            'admin.search_last_rebuild'   => 'Last rebuild',
            'admin.search_never_rebuilt'  => 'Never rebuilt from the console',
            'admin.search_oldest_pending' => 'Waiting since',
            'admin.search_pending'        => {
                one   => '{count} event waiting',
                other => '{count} events waiting',
            },
            'admin.search_rebuild_hint' =>
'Index every thread and post again, in the background, and remove documents whose source is gone. Safe while the forum serves.',
            'admin.search_rebuild_requested' =>
              'Search rebuild started: it runs in the background.',
            'admin.search_rebuild_totals' =>
            ...
            'forum.error_conflict_message' =>
'The request conflicts with what is there now. Reload the page and try again.',
            'forum.error_conflict_title' => 'Conflict',
            'forum.error_csrf_message'   =>
'The form was open too long or came from another page. Reload it and submit again.',
            'forum.error_csrf_title'        => 'Form expired',
            'forum.error_detail'            => 'Details',
            'forum.error_forbidden_message' =>
              'Your account does not have permission to do this.',
            'forum.error_forbidden_title'  => 'Access denied',
            'forum.error_internal_message' =>
              'The request failed on our side. Try again in a moment.',
            'forum.error_internal_title'  => 'Something went wrong',
            'forum.error_invalid_message' =>
'The request could not be accepted. Check what you entered and try again.',
            'forum.error_invalid_title'     => 'Invalid request',
            'forum.error_not_found_message' =>
              'What you asked for does not exist, or is not visible to you.',
            'forum.error_not_found_title'      => 'Not found',
            'forum.error_rate_limited_message' =>
'Too many requests in a short time. Wait a moment, then try again.',
            'forum.error_rate_limited_title'   => 'Too many requests',
            'forum.error_unauthorized_message' =>
              'This page is for signed-in members.',
            'forum.error_unauthorized_title'  => 'Sign in required',
            'forum.error_unavailable_message' =>
'The service cannot complete this right now. Try again in a moment.',
            'forum.error_unavailable_title' => 'Temporarily unavailable',
...
'This thread is hidden. Only you can see it until you restore it.',
            ...
            'forum.visibility_inherit' => 'Same as the category',
...
'Operators replace this page with instance-specific terms before production. The software is BSD-3 licensed.',
            ...
            'settings.timezone_default' => 'Forum default ({zone})',
            'settings.timezone_help'    =>
              'Dates and times across the forum are shown in this zone.',
            ...
            'notifications.unread_many'   => 'More than 99 unread',
...
'Account {username} creato. Controlla l’email per verificare prima di accedere.',
            ...
            'admin.revoke_binding_consequence' =>
              'L’utente perde subito i permessi di questo ruolo.',
            'form.confirm_understood'        => 'Ho capito cosa comporta',
            'moderation.suspend_consequence' =>
'L’utente non può accedere né pubblicare finché la sospensione non scade o viene revocata.',
            'privacy.approve_erasure_consequence' =>
'Pianifica la cancellazione dei dati personali di questo account.',
            'privacy.run_erasure_consequence' =>
'Cancella ora i dati personali di questo account. Non si può annullare.',
            'admin.audit_clear_filters'      => 'Azzera filtri',
            'admin.audit_filters'            => 'Filtri audit',
            'admin.audit_from'               => 'Dal (giorno UTC)',
            'admin.audit_invalid_filter'     => 'Valore non valido per',
            'admin.audit_older'              => 'Voci più vecchie',
            'admin.audit_until'              => 'Al (giorno UTC)',
            ...
            'admin.failure_type'             => 'Tipo di errore',
            'admin.dead_letter_replay_hint'  =>
'Risolta la causa, rimetti in coda il lavoro come nuovo messaggio. Il messaggio fallito e questo record restano come sono.',
            'admin.dead_letter_replayed' =>
...
'Scarta ogni pagina pubblica in cache. Ciascuna viene ricreata alla visita successiva; non si perde nulla.',
            ...
            'admin.search_pending'        => {
                one   => '{count} evento in attesa',
                other => '{count} eventi in attesa',
            },
            'admin.search_rebuild_hint' =>
'Indicizza di nuovo ogni discussione e post, in background, e rimuove i documenti la cui origine non c’è più. Sicuro con il forum in funzione.',
            'admin.search_rebuild_requested' =>
              'Ricostruzione della ricerca avviata: procede in background.',
            'admin.search_rebuild_totals' =>
            ...
            'forum.error_conflict_message'   =>
'La richiesta è in conflitto con lo stato attuale. Ricarica la pagina e riprova.',
            'forum.error_conflict_title' => 'Conflitto',
            'forum.error_csrf_message'   =>
'Il modulo è rimasto aperto troppo a lungo o proviene da un\'altra pagina. Ricaricalo e invialo di nuovo.',
            'forum.error_csrf_title'        => 'Modulo scaduto',
            'forum.error_detail'            => 'Dettagli',
            'forum.error_forbidden_message' =>
              'Il tuo account non ha i permessi per questa operazione.',
            'forum.error_forbidden_title'  => 'Accesso negato',
            'forum.error_internal_message' =>
'La richiesta non è riuscita per un problema del server. Riprova tra poco.',
            'forum.error_internal_title'  => 'Si è verificato un errore',
            'forum.error_invalid_message' =>
'La richiesta non è stata accettata. Controlla i dati inseriti e riprova.',
            'forum.error_invalid_title'     => 'Richiesta non valida',
            'forum.error_not_found_message' =>
              'Ciò che hai richiesto non esiste o non è visibile per te.',
            'forum.error_not_found_title'      => 'Non trovato',
            'forum.error_rate_limited_message' =>
              'Troppe richieste in poco tempo. Attendi un momento e riprova.',
            'forum.error_rate_limited_title'   => 'Troppe richieste',
            'forum.error_unauthorized_message' =>
'Questa pagina è riservata agli utenti che hanno effettuato l\'accesso.',
            'forum.error_unauthorized_title'  => 'Accesso richiesto',
            'forum.error_unavailable_message' =>
'Il servizio non può completare l\'operazione in questo momento. Riprova tra poco.',
            'forum.error_unavailable_title' =>
...
'Questa discussione è nascosta. Solo tu puoi vederla finché non la ripristini.',
            ...
            'forum.visibility_inherit' => 'Come la categoria',
            ...
            'moderation.staff_reason'           =>
              'La tua motivazione (registrata nel log di audit)',
...
'Gli operatori sostituiscono questa pagina con i termini dell\'istanza prima della produzione. Il software è con licenza BSD-3.',
            ...
            'settings.timezone_default' => 'Predefinito del forum ({zone})',
            'settings.timezone_help'    =>
              'Date e orari del forum vengono mostrati in questo fuso.',
...
'Apri GPForum per leggere la nuova risposta in una discussione seguita.',
            ...
            'notifications.unread_many'   => 'Più di 99 non lette',
            ...
            'state.replayed'                  => 'Rimessa in coda',
