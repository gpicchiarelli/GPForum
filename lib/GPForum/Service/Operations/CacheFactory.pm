...
A reachable GlifiStore is not required at process start. Transport failures
degrade to L1 and PostgreSQL while the shared client retries. The shared
client is opened with C<connect_required>.
