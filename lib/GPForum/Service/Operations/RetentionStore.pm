...
sub _dead_letter_query ( $self, $input ) {
    return {
        last_failed_at => {
            $LTE => $self->_cutoff_iso(
...
sub _cutoff_iso ( $self, $input, $field, $default_days ) {
