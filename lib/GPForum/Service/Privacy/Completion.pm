...
sub completion_replay ( $, $erasure_job_id ) {
    return {
...
sub hold_block_replay ( $, $erasure_job_id ) {
    return {
        erasure_job_id => $erasure_job_id,
