...
sub _email_verification_in_txn {
    my ( $self, $input ) = @_;
...
sub _email_verification_missing {
    my ( $self, $input ) = @_;
...
sub _confirm_email_verification_in_txn {
    my ( $self, $input ) = @_;
...
sub _confirm_email_change_in_txn {
    my ( $self, $input ) = @_;
...
sub _confirmed_email_user {
    my ( $self, $token, $email ) = @_;
...
sub _record_user_action {
    my ( $self, $user, $action, $metadata ) = @_;
...
sub _email_belongs_to_other {
    my ( $self, $existing, $current_user_id ) = @_;
