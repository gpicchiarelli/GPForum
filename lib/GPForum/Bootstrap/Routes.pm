...
sub register ( $, %input ) {
    ...
    $routes->post('/admin/dead-letters/:dead_letter_id/replay')
      ->to('Admin::DeadLetters#replay')
      ->name('admin_dead_letter_replay');
    $routes->post('/admin/search/rebuild')
      ->to('Admin::Maintenance#search_rebuild')
      ->name('admin_search_rebuild');
    $routes->post('/admin/cache/purge')
