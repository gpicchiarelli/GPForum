...
# ADR 0102: a new thread inherits its category's visibility unless its
# author narrows it.
const my $DEFAULT_VISIBILITY => q{};
...
sub _form_payload ( $self, $input, $state, $fields ) {
    return {
...
sub _selected_category_id ( $self, $input, $values ) {
...
sub _command_id ( $self, $input, $values ) {
