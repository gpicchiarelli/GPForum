...
sub modified_since_matches {
    my ( $self, $candidate, $last_modified_epoch ) = @_;
...
sub revalidated_state {
    my ( undef, $cache_state ) = @_;
...
sub _etag_token_matches {
    my ( undef, $candidate, $etag ) = @_;
...
sub _epoch_not_after {
    my ( undef, $candidate, $last_modified_epoch ) = @_;
