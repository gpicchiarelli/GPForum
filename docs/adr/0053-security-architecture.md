...
Accepted. Its upload antivirus MUST is implemented by ADR 0108, which
scans uploads with the operating system's free antivirus.

Converted on 2026-09-19 from `prompt/5.txt` ("GPForum — Security Architecture
Constitution"); this ADR replaces the prompt as the binding source.
