...
- `GPForum::Bootstrap::Forum` registers forum readers, composers, stores,
  ...
  forum controllers.
- `GPForum::Bootstrap::Admin` registers role, permission, audit, admin
  console, and admin workflow helpers.
- `GPForum::Bootstrap::Moderation` registers report, moderation action,
  suspension, moderation review, and moderation workflow helpers.
