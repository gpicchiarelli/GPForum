...
- I servizi più grandi sono `Service::I18N` con 1.390 righe,
  `Service::Identity::Store` con 917 righe, `Service::Attachment::Store` con
  574 righe, `Service::Privacy::DeletionWorkflow` con 568 righe e
  `Service::Outbox::Dispatcher` con 473 righe.
...
| `Identity::Store` troppo largo | ARCHITECTURAL | 0-12 mesi | Alto |
...
4. Separare `Identity::Store`:
   `CredentialStore`, `SessionStore`, `IdentityTokenStore`,
   `IdentityAuditService`, lasciando un workflow sottile sopra.
