...
No system PostgreSQL server, or no `sudo`? A user-space cluster on another
port is enough for development; `docs/ops/staging-drills.md` shows the four
commands and the matching `GPFORUM_DATABASE_DSN`.
...
`make check` needs no database: the PostgreSQL integration tests skip unless
...
| Private beta | Not yet | Staging TLS / SMTP `--send` / target install still open — Cloud Agent live verify + stress 100 in [docs/ops/evidence/2026-09-20-cloud-agent-live/](docs/ops/evidence/2026-09-20-cloud-agent-live/); stress 500/1000 in [docs/ops/evidence/2026-09-20-cloud-agent-stress500/](docs/ops/evidence/2026-09-20-cloud-agent-stress500/); walk [docs/ops/private-beta-checklist.md](docs/ops/private-beta-checklist.md) |
