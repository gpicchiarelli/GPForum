...
is( $search_documents->last_query->{-and}[0]{visibility}{-in}[1],
    'private', 'search applies permission visibility scopes' );
is( $search_documents->last_query->{-and}[0]{category_id},
    'category-1', 'search applies category filter' );
is( $search_documents->last_query->{-and}[0]{author_user_id},
    'user-1', 'search applies author filter' );
is( $search_documents->last_query->{-and}[1]{source_created_at}{'>='},
