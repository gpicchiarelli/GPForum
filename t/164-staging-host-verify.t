...
sub _test_prerequisites_only {
    ...
    is( $evidence->{env_file}{status},
        'skipped', 'env_file skipped by default' );
...
ENV
    ...
    is_deeply( $evidence->{env_file}{missing_keys},
        [], 'no missing required keys' );
    ok(
        $evidence->{env_file}{values_redacted},
