...
const my $SESSION_TOKEN    => 'probe-session-token';
...
sub _row {
    ...
    # validate_session now compares the presented bearer token against the
    # stored digest, so a session fixture has to carry one.
    return {
