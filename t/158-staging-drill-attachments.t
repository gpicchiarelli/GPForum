...
sub _test_attachment_drill {
    ...
    ok(
        $attachments->{secrets_redacted},
        'attachment drill marks secrets_redacted'
    );
    is( $attachments->{private_beta_claimed},
        0, 'attachment drill refuses private-beta claim' );
...
sub _test_deploy_drill {
    ...
    is( $deploy->{private_beta_claimed},
        0, 'deploy checklist refuses private-beta claim' );
...
sub _test_combined_command {
    ...
    is( $combined->{private_beta_claimed},
        0, 'combined drill refuses private-beta claim' );
