...
my $target_audit =
  $audit_review->page( { target_type => 'post', target_id => 'post-1' },
    { limit => $AUDIT_LIMIT } )->{rows};
...
$review_actions->create(
    {
        moderation_action_id => '018f1000-0000-7000-8000-00000000a00a',
        actor_user_id        => 'moderator-1',
...
$review_actions->create(
    {
        moderation_action_id => '018f1000-0000-7000-8000-00000000a00b',
        actor_user_id        => 'moderator-1',
...
$review_actions->create(
    {
        moderation_action_id => '018f1000-0000-7000-8000-00000000a00c',
...
is(
    ...
    '018f1000-0000-7000-8000-00000000a00b',
