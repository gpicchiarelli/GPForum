...
subtest 'rate limiter degrades to local store and audits blocked events' =>
  sub {
    ...
    my $limiter = GPForum::Service::Operations::RateLimiter->new(
        ...
        # Degrading to the local store is the development behaviour and has to
        # be asked for; see t/172-rate-limiter-degradation.t for the
        # fail-closed default that staging and production get.
        degradation_policy =>
