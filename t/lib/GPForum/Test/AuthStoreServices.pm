...
has verifications => sub { return []; };

sub decoy_hash { return 'decoy'; }

sub verify_password {
    my ( $self, $password, $hash ) = @_;

    push @{ $self->verifications }, $hash;
...
The fake decoy hash, C<decoy>.

=head2 verify_password

Compares a password against a deterministic fake hash, and records the hash
it was given in C<verifications>.
